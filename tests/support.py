...
CONTROLLED_VARIABLES = (
    ...
    "CLAUDE_PLUGIN_OPTION_TOP_TIER_CONCURRENCY",
    "CLAUDE_PLUGIN_OPTION_AGENT_WIDTH",
    "CLAUDE_PLUGIN_OPTION_NESTED_TOP_TIER_BUDGET",
    "CLAUDE_PLUGIN_OPTION_NESTED_AGENT_BUDGET",
    "CLAUDE_PLUGIN_OPTION_IDLE_MINUTES",
